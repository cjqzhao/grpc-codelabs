const _: () = ::protobuf::__internal::assert_compatible_gencode_version("4.31.1-release");
...
unsafe impl ::protobuf::ProxiedInRepeated for Point {
  ...
  unsafe fn repeated_get_mut_unchecked(
    ...
    // - `i < len(f)` is promised by the caller.
    let msg_ptr = unsafe { ::protobuf::__internal::runtime::upb_Array_GetMutable(f.as_raw(::protobuf::__internal::Private), i) };
    unsafe {::protobuf::Mut::<Self> { inner: ::protobuf::__internal::runtime::MutatorMessageRef::from_raw_parts(msg_ptr, f.arena(::protobuf::__internal::Private)) } }
  }
...
impl ::protobuf::__internal::runtime::UpbTypeConversions for Point {
    ...
    unsafe fn from_message_mut<'msg>(msg: *mut ::protobuf::__internal::runtime::upb_Message, arena: &'msg ::protobuf::__internal::runtime::Arena)
        -> PointMut<'msg> {
        PointMut {
          inner: unsafe {
            ::protobuf::__internal::runtime::MutatorMessageRef::from_raw_parts(std::ptr::NonNull::new(msg).expect("expected present message value in map"), arena)
          }
        }
    }
}
...
impl ::protobuf::CopyFrom for PointMut<'_> {
  fn copy_from(&mut self, src: impl ::protobuf::AsView<Proxied = Point>) {
    // SAFETY: self and src are both valid `Point`s associated with
    // `Self::mini_table()`.
    unsafe {
      assert!(
...
impl ::protobuf::CopyFrom for FeatureMut<'_> {
  fn copy_from(&mut self, src: impl ::protobuf::AsView<Proxied = Feature>) {
    // SAFETY: self and src are both valid `Feature`s associated with
    // `Self::mini_table()`.
    unsafe {
      assert!(
        ::protobuf::__internal::runtime::upb_Message_DeepCopy(
